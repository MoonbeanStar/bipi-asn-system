<header class="main-header">
  ...
  <a href="#" class="logo">
    ...
    <span class="logo-mini"><b>A</b>SN</span>
    <!-- logo for regular state and mobile devices -->
    <span class="logo-lg"><b>ASN System</span>
  </a>
          ...
          <ul class="dropdown-menu">
            ...
            <li class="user-footer">
              <div class="pull-left">
			    ...
			    <div class="pull-left">
                <a href="#profileadd" data-toggle="modal" class="btn btn-default btn-flat" id="admin_profile">Add</a>
              </div>
