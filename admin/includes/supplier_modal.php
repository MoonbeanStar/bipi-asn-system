            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="supplier_add.php" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="password" name="supplier_id" required>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="supplier_edit.php">
                <input type="hidden" class="suppid" name="id">
                <div class="form-group">
				...
				<div class="form-group">
                    <label for="edit_password" class="col-sm-3 control-label">Login Password</label>

                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="edit_password" name="supplier_id">
                    </div>
                </div>
            </div>
            <div class="modal-footer">
